...
interface CashDrawerRepository {
    ...
    suspend fun getCurrentSession(cashierId: String? = null): Result<CashDrawerSession?>
    ...
    suspend fun getSummary(cashierId: String? = null): Result<DrawerSummary>
    suspend fun getAllOpenSessions(): Result<List<CashDrawerSession>>
}
