...
val StatusDeliveryFailed = Color(0xFFDC2626)// Red 600
val StatusReturned = Color(0xFF78716C)      // Stone 500
...
val InStoreColor = Color(0xFF6A1B9A)        // Purple
val PickupLaterColor = Color(0xFF00838F)    // Teal
