    ...
    private fun runMigrations(driver: SqlDriver) {
        ...
        val createStatements = listOf(
            """CREATE TABLE IF NOT EXISTS vendors (
                ...
                enable_digital_menu INTEGER NOT NULL DEFAULT 1,
                enable_recipe INTEGER NOT NULL DEFAULT 1,
                enable_split_payment INTEGER NOT NULL DEFAULT 1,
                enable_cash_drawer INTEGER NOT NULL DEFAULT 1,
                enable_returns INTEGER NOT NULL DEFAULT 1,
                enable_customer_credit INTEGER NOT NULL DEFAULT 0,
                enable_installments INTEGER NOT NULL DEFAULT 0,
                enable_pre_orders INTEGER NOT NULL DEFAULT 0,
                enable_scheduled_orders INTEGER NOT NULL DEFAULT 0,
                enable_suppliers INTEGER NOT NULL DEFAULT 1,
                enable_drug_interactions INTEGER NOT NULL DEFAULT 0,
                enable_prescriptions INTEGER NOT NULL DEFAULT 0,
                enable_analytics INTEGER NOT NULL DEFAULT 1,
                enable_announcements INTEGER NOT NULL DEFAULT 1,
                enable_stock INTEGER NOT NULL DEFAULT 1,
                enable_attendance INTEGER NOT NULL DEFAULT 1,
                enable_overtime INTEGER NOT NULL DEFAULT 0,
                enable_salary INTEGER NOT NULL DEFAULT 0,
                enable_customers INTEGER NOT NULL DEFAULT 1,
                enable_export INTEGER NOT NULL DEFAULT 1,
                enable_digital_receipt INTEGER NOT NULL DEFAULT 0,
                enable_worker_qrcode INTEGER NOT NULL DEFAULT 0,
                enable_loyalty INTEGER NOT NULL DEFAULT 0,
                enable_manual_discount INTEGER NOT NULL DEFAULT 1,
                enable_offers INTEGER NOT NULL DEFAULT 1,
