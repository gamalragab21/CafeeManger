...
fun Vendors.toDomain() = Vendor(
    ...
    enableDigitalMenu = enable_digital_menu,
    enableRecipe = enable_recipe,
    enableSplitPayment = enable_split_payment,
    enableCashDrawer = enable_cash_drawer,
    enableReturns = enable_returns,
    enableCustomerCredit = enable_customer_credit,
    enableInstallments = enable_installments,
    enablePreOrders = enable_pre_orders,
    enableScheduledOrders = enable_scheduled_orders,
    enableSuppliers = enable_suppliers,
    enableDrugInteractions = enable_drug_interactions,
    enablePrescriptions = enable_prescriptions,
    enableAnalytics = enable_analytics,
    enableAnnouncements = enable_announcements,
    enableStock = enable_stock,
    enableAttendance = enable_attendance,
    enableOvertime = enable_overtime,
    enableSalary = enable_salary,
    enableCustomers = enable_customers,
    enableExport = enable_export,
    enableDigitalReceipt = enable_digital_receipt,
    enableWorkerQrcode = enable_worker_qrcode,
    enableLoyalty = enable_loyalty,
    enableManualDiscount = enable_manual_discount,
...
fun Vendor.toDbEntity() = Vendors(
    ...
    enable_pre_orders = enablePreOrders,
