...
class VendorDao(private val db: WaselakDatabase) {
    ...
    suspend fun insertVendor(vendor: Vendors) {
        queries.insertVendor(
            ...
            enable_digital_menu = vendor.enable_digital_menu,
            enable_recipe = vendor.enable_recipe,
            enable_split_payment = vendor.enable_split_payment,
            enable_cash_drawer = vendor.enable_cash_drawer,
            enable_returns = vendor.enable_returns,
            enable_customer_credit = vendor.enable_customer_credit,
            enable_installments = vendor.enable_installments,
            enable_pre_orders = vendor.enable_pre_orders,
            enable_scheduled_orders = vendor.enable_scheduled_orders,
            enable_suppliers = vendor.enable_suppliers,
            enable_drug_interactions = vendor.enable_drug_interactions,
            enable_prescriptions = vendor.enable_prescriptions,
            enable_analytics = vendor.enable_analytics,
            enable_announcements = vendor.enable_announcements,
            enable_stock = vendor.enable_stock,
            enable_attendance = vendor.enable_attendance,
            enable_overtime = vendor.enable_overtime,
            enable_salary = vendor.enable_salary,
            enable_customers = vendor.enable_customers,
            enable_export = vendor.enable_export,
            enable_digital_receipt = vendor.enable_digital_receipt,
            enable_worker_qrcode = vendor.enable_worker_qrcode,
            enable_loyalty = vendor.enable_loyalty,
            enable_manual_discount = vendor.enable_manual_discount,
            enable_offers = vendor.enable_offers,
