    ...
    application {
        ...
        nativeDistributions {
            ...
            macOS {
                ...
                dockName = if (isDebugDesktop) "Waselak Delivery Debug" else "Waselak Delivery"
            ...
            windows {
                ...
                perUserInstall = true
                dirChooser = true
                upgradeUuid = if (isDebugDesktop) "c3d4e5f6-a7b8-9012-cdef-123456789013" else "c3d4e5f6-a7b8-9012-cdef-123456789012"
